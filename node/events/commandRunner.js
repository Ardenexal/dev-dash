...
var CommandRunner = /** @class */ (function () {
    ...
    CommandRunner.prototype.handle = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var ssh, connection, output, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        connection = _a.sent();
                        return [4 /*yield*/, connection.exec(options.commandOutput, [], {
                    ...
                    case 4:
                        e_1 = _a.sent();
                        debugger;
                        options.sender.send(options.id, { message: e_1.toString(), type: 'danger' });
